export default function page() {
  return (
    <div className="relative h-screen text- flex items-center justify-center w-full">
      ...
      <form className="mx-auto bg-white w-[40%] px-[50px] py-[50px] rounded-md">
        ...
        <button
          type="submit"
          class="text-white font-aceng bg-blue-700 ml-auto block mt-5 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
        >
          submit
        </button>
      </form>
